defmodule PhoenixReactCuratedListWeb.BlogsController do
  use PhoenixReactCuratedListWeb, :controller

  alias PhoenixReactCuratedListWeb.Blogs #insert this line
  alias PhoenixReactCuratedList.Repo
  ...
  def update(conn, %{"id" => id, "blog" => blogs_params}) do
    blog = Repo.get(Blogs, id)
